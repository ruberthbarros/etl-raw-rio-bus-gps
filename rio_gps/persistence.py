...
def write_data_to_csv_file(file_path, data, delimiter=";"):
    ...
    with open(file_path, "w") as file_:
        ...
        for row in data["rows"]:
            ...
            rows_list.append(str.join(delimiter, row_str))
...
def upload_file_to_s3(file_path, bucket, object_name=None, access_key_id=None,
    ...
    Args:
        ...
        access_key_id (str, optional): programatic access key id.
        Only used in dev environment. Defaults to None.
        secret_access_key (str, optional):programatic access key id.
        Only used in dev environment. Defaults to None.
    """
